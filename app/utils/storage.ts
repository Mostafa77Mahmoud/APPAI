...
// Enhanced store session data with validation
export const storeSessionData = async (
  ...
  try {
    ...
    const storage = getStorage(dataString.length);
...
export const getSessionData = async (
  ...
  try {
    ...
    const dataString = await storage.getItem(storageKey);
...
export const getOrCreateDeviceId = async (): Promise<string> => {
  try {
    ...
    // Store the new device ID securely
